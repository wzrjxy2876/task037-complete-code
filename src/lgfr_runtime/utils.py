...
CONFIG_PATHS = {
    'swintrans': os.path.join(CONFIG_ROOT, 'swintrans.yaml'),
...
# save info
OPT_PATH = '/data/jixinye25/work1/work1_output/UCF-swintrans' # output path
...
# ucf dataset
UCF_DATA_ROOT = '/data/jixinye25/UCF101_Frame/frames' # ucf101 dataset path
